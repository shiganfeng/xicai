  ...
  <div class="app-container policy-list">
    <el-row class="myxue">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: '/ChuangrongList' }"><span class="sgftitle">楼宇</span></el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    <el-divider></el-divider>
    <el-row>
      <el-col :span="1">
        <router-link to="/chuangInfo">
            ...
            <template>
              <template>
                <el-tooltip effect="dark" content="编辑" placement="top" :enterable="false" >
                  <router-link :to="`/chuangInfo?id=${row.xid}`">
...
<script>
import { CRShaixuan,CRGetEnterList,CRDeleteInfo,CRRetest,CRGetEditInfo,CRGetList,CRLouyuShaixuan } from '../../api/login.js'
export default {
  data() {
    return {
      total: 0,
  ...
  methods: {
    ...
    async getEnterList(){
          ...
          console.log(this.sgfPage)
          let mydata = await CRGetList(requestData)
          console.log(mydata)
    ...
    async shaixuan(){
      ...
      console.log(requestData)
          let shaixuandata = await CRLouyuShaixuan(requestData).catch((res) => {
            console.log(res)
          })

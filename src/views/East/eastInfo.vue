<template>
  <div class="policy-info">
    <el-row class="myxue">
      <el-breadcrumb>
        <el-breadcrumb-item :to="{ path: '/EastList' }"><span class="sgftitle">无锡东站</span></el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/eastInfo' }"><span class="sgftitle">{{$route.query.id ? '编辑' : '新增'}}</span></el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    :model="ruleForm" :rules="rules" label-width="210px" v-loading="loading">
      ...
      <el-row>
        ...
        <el-form-item class="myItem">
          <el-button @click="$router.push('/EastList')" class="mycancle" type="danger">取消</el-button>
  ...
  methods: {
    ...
    async sgfGetEditList(){
      ...
      if(this.ruleForm.belogArea == '创融大厦A座'){
        ...
        this.sgfGetChuangDLocation()
      }else if(this.ruleForm.belogArea == '无锡东站A'){
        this.sgfGetDongALocation()
      }else if(this.ruleForm.belogArea == '无锡东站B'){
        this.sgfGetDongBLocation()
      }else if(this.ruleForm.belogArea == '无锡东站C'){
        this.sgfGetDongCLocation()
      }else if(this.ruleForm.belogArea == '无锡东站下沉'){
        this.sgfGetXiaLocation()
      }else if(this.ruleForm.belogArea == '多经'){
        this.sgfGetDuoLocation()
      }else if(this.ruleForm.belogArea == '兖矿信达大厦'){
        this.sgfGetYanLocation()

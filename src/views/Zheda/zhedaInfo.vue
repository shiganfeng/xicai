  ...
  <div class="policy-info">
    <el-row class="myxue">
      <el-breadcrumb>
        ...
        <el-breadcrumb-item :to="{ path: '/zhedaInfo' }"><span class="sgftitle">{{$route.query.id ? '编辑' : '新增'}}</span></el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    :model="ruleForm" :rules="rules" label-width="210px" v-loading="loading">
      ...
      <el-row>
        ...
        <el-form-item class="myItem">
          <el-button @click="$router.push('/ZhedaList')" class="mycancle" type="danger">取消</el-button>
